...
namespace QuanLyKhachSan.Forms
{
    ...
    {
        private System.ComponentModel.IContainer components = null; private Label lblKetQua; private Button btnTimPhong, btnLapPhieu;
        ...
        private void InitializeComponent()
        {
            ...
            filter.Controls.Add(UiTheme.Field("Ngày nhận", new DateTimePicker { Width = 180, Format = DateTimePickerFormat.Custom, CustomFormat = "dd/MM/yyyy" })); filter.Controls.Add(UiTheme.Field("Ngày trả", new DateTimePicker { Width = 180, Value = System.DateTime.Today.AddDays(1), Format = DateTimePickerFormat.Custom, CustomFormat = "dd/MM/yyyy" }));
            filter.Controls.Add(UiTheme.Field("Số khách", new NumericUpDown { Width = 180, Minimum = 1, Maximum = 20, Value = 2 })); btnTimPhong = UiTheme.Button("Tìm phòng trống", true); btnTimPhong.Width = 145; btnTimPhong.Click += btnTimPhong_Click; filter.Controls.Add(btnTimPhong);
            ...
            var available = UiTheme.Grid("Chọn", "Số phòng", "Khu vực", "Sức chứa", "Đơn giá", "Trạng thái"); available.Rows.Add("", "A101", "Khu A", "2", "600.000", "Trống"); available.Rows.Add("", "A102", "Khu A", "3", "800.000", "Trống"); available.Rows.Add("", "B201", "Khu B", "4", "1.200.000", "Trống"); root.Controls.Add(available, 0, 1);
            ...
            ci.Controls.Add(UiTheme.Grid("Số phiếu", "Khách đặt", "Ngày nhận", "Ngày trả", "Phòng", "Trạng thái"), 0, 0); var ciEdit = new FlowLayoutPanel { Dock = DockStyle.Fill, BackColor = Color.White, Padding = new Padding(12) };
            ciEdit.Controls.Add(UiTheme.Field("Họ tên người ở", UiTheme.Input("txtNguoiO"))); ciEdit.Controls.Add(UiTheme.Field("CCCD", UiTheme.Input("txtCCCD"))); ciEdit.Controls.Add(UiTheme.Field("Quốc tịch", UiTheme.Input("txtQuocTich"))); ciEdit.Controls.Add(UiTheme.Button("Thêm người ở", false)); ciEdit.Controls.Add(UiTheme.Button("Nhận phòng", true)); ci.Controls.Add(ciEdit, 0, 1); checkin.Controls.Add(ci);
