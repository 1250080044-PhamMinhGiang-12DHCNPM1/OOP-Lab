...
namespace QuanLyKhachSan.Forms
{
    partial class FrmThongKe
    {
        ...
        private void InitializeComponent()
        {
            ...
            var filter = new FlowLayoutPanel { Dock = DockStyle.Fill, BackColor = Color.White, Padding = new Padding(8) }; filter.Controls.Add(UiTheme.Field("Từ ngày", new DateTimePicker { Name = "dtTu", Width = 180, Value = System.DateTime.Today.AddDays(-30), Format = DateTimePickerFormat.Custom, CustomFormat = "dd/MM/yyyy" })); filter.Controls.Add(UiTheme.Field("Đến ngày", new DateTimePicker { Name = "dtDen", Width = 180, Format = DateTimePickerFormat.Custom, CustomFormat = "dd/MM/yyyy" })); var show = UiTheme.Button("Xem thống kê", true); show.Name = "btnThongKe"; filter.Controls.Add(show); root.Controls.Add(filter, 0, 0);
            ...
            var roomGroup = new GroupBox { Text = "Tổng hợp đặt phòng và hóa đơn", Dock = DockStyle.Fill, Padding = new Padding(10), Font = new Font("Segoe UI Semibold", 10F) }; var summaryGrid = UiTheme.Grid("Ngày", "Số hóa đơn", "Doanh thu", "Đền bù"); summaryGrid.Name = "dgvTongHop"; roomGroup.Controls.Add(summaryGrid); root.Controls.Add(roomGroup, 0, 2);
            var serviceGroup = new GroupBox { Text = "Dịch vụ được sử dụng", Dock = DockStyle.Fill, Padding = new Padding(10), Font = new Font("Segoe UI Semibold", 10F) }; var serviceGrid = UiTheme.Grid("Mã dịch vụ", "Tên dịch vụ", "Tổng số lượng", "Tổng tiền"); serviceGrid.Name = "dgvDichVu"; serviceGroup.Controls.Add(serviceGrid); root.Controls.Add(serviceGroup, 0, 3);
